    ...
    var t, e = {
        5267: (t,e,i)=>{
            ...
            var c = "LOADER_INIT"
              ...
              , C = function() {
                return ((0,
                L.Z)(navigator.userAgent).any || A() || R()) && z()
            }
              , I = function() {
              ...
              , B = function(t) {
                if (!I())
                    return t.classList.remove("is-anim-loading"),
                    !1;
            ...
            var U = function() {
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        this.isResizeObserver && new ResizeObserver((function() {
                            D.emit(f),
                            t.isResing = !0,
                    ...
                    value: function(t) {
                        ...
                        0 === this.scrollHistory.length ? this.scrollHistory[0] = {
                            path: e,
                            scrollTop: i
                        } : (1 === this.scrollHistory.length || (this.scrollHistory[0] = this.scrollHistory[1]),
            ...
            var tt = function() {
                function t(e) {
                    ...
                    _() && 1 !== parseFloat(i) || (this.handle = this.DOM.el.getAttribute("data-handle") || "all",
                    this.isParallax = this.DOM.el.getAttribute("data-lenis-parallax") || !1,
                    this.props = {
                        parallax: parseFloat(i) || 0,
                        current: 0
                    },
                    this.propsParent = {},
                    this.DOM.parent = this.DOM.el.closest(".js-lenis-speed__parent") || this.DOM.el.parentElement,
                ...
                (i = [{
                    ...
                    value: function(t) {
                        if (!("lg" === this.handle && Z.winSize.width < 1200))
                            if (this.isParallax)
                                this.DOM.el.style = "--offset-parallax: ".concat(t * this.props.parallax, "px");
                            else {
                                ...
                                n = Math.max(n, i),
                                this.props.parallax >= 1 && (n = Math.max(Math.min(n, this.propsParent.height), 0)),
                                this.props.current = n,
                                this.DOM.el.style = "--offset-parallax: ".concat(this.props.current, "px")
                            }
                    }
                }, {
                    key: "bindEvent",
                    ...
                    key: "clear",
                    value: function() {
                        D.off(h, this.getProp),
                        D.off(f, this.getProp)
                    }
                }]) && Q(e.prototype, i),
                n && Q(e, n),
                Object.defineProperty(e, "prototype", {
            ...
            var ct = function() {
                function t(e) {
                    ...
                    this.DOM.el.classList.contains("is-intersection") && (this.isGsap = !1),
                    this.addObServer(),
                    this.bindEvent()
                }
                var e, i, n;
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        this.DOM.el.style = {},
                        !I() || this.isGsap ? (this.id = (Math.random() + (new Date).getTime()).toString(),
                        st.i.create({
                            trigger: this.DOM.el,
                            markers: !1,
                            id: this.id,
                    ...
                    value: function() {
                        ...
                        if (!this.isLoaded) {
                            ...
                            i && (C() || z()) ? e.setAttribute("srcset", i) : e.setAttribute("srcset", this.DOM.el.getAttribute("data-srcset")),
                    ...
                    key: "destroy",
                    value: function() {
                        this.id && st.i.getById(this.id) && st.i.getById(this.id).kill(),
                ...
                i = [{
                    ...
                    value: function(t) {
                        for (var e = 0; e < this.filterSvgLoader_.length; e++)
                            if (this.filterSvgLoader_[e] && this.filterSvgLoader_[e].src === t)
                                return e;
                        return !1
                    }
                }, {
                        ...
                        this.DOM_.svgs.forEach((function(t) {
                            ...
                            if (i.test(n)) {
                                ...
                                if (!1 === r) {
                                    ...
                                    o.elements.push(t),
                                    e.filterSvgLoader_.push(o)
                                } else
                                    e.filterSvgLoader_[r].elements.push(t)
                            }
                        }
                        ))
                    }
                        ...
                        setTimeout((function() {
                            for (var t = function() {
                                ...
                                n.push(new Promise((function(e) {
                                    i.caching[t.src] ? (i.initSvgIn(r, i.caching[t.src], t),
                                    e()) : fetch(t.src).then((function(t) {
                                        return t.text()
                                    }
                                    )).then((function(n) {
                                        i.caching[t.src] = n,
                            ...
                            }, o = 0; o < i.filterSvgLoader_.length; o++)
                                t();
            ...
            var Ot = function() {
                function t() {
                    ...
                    this.DOM.main && (this.countTouch = 0,
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        this.countTouch++,
                        this.countTouch >= 3 ? (this.countTouch = 0,
                        this.enabled = "false" === this.enabled ? "true" : "false",
                        this.layout(),
                        localStorage.setItem("isGrid", String(this.enabled))) : this.timeClear = setTimeout((function() {
                            t.countTouch = 0
                        }
                        ), 200)
                    }
                    ...
                    value: function(t) {
                        ...
                        t.shiftKey && 71 === e && (this.enabled = "false" === this.enabled ? "true" : "false",
                        this.layout(),
            ...
            var Dt = function() {
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        document.querySelectorAll('a[href^="#"]:not(.has-tag-handle), a[href^="/#"]:not(.has-tag-handle)').forEach((function(e) {
                            var i = function(t) {
                                return t.replace("/", "")
                            }(e.getAttribute("href"));
                            H(i) && document.querySelector(i) && (e.classList.add("has-tag-handle"),
                            e.addEventListener("click", (function(e) {
                                e.preventDefault(),
                                t._handleLocationHasTag(i)
                            }
                            )))
                        }
                        ))
                    ...
                    value: function() {
                        ...
                        this.onShowTimeout = !1,
                        this.bodyClass(),
                        this.winSize.width !== this.calcWinSize.width && (this.winSize.width = this.calcWinSize.width,
                        D.emit("HT_RESIZE_WIDTH")),
                        this.winSize.height !== this.calcWinSize.height && (this.winSize.height = this.calcWinSize.height,
                    ...
                    value: function() {
                        ...
                        window.addEventListener("resize", (function() {
                            t.calcWin(),
                            (!_() || _() && t.winSize.width !== t.calcWinSize.width) && (t.winSize.width = t.calcWinSize.width,
                            t.onShowTimeout || (t.onShowTimeout = !0,
                            ot.p8.set(t.layoutReize, {
                                opacity: 1,
                                zIndex: 9999
                            })),
                            t.callBeforeResize || (t.callBeforeResize = !0,
                            D.emit("BEFORE_HT_RESIZE")),
                            t.idSetTimeoutWindowResize && clearTimeout(t.idSetTimeoutWindowResize),
                            t.idSetTimeoutWindowResize = setTimeout(t.timeoutWindowResize, 350))
                        }
                        )),
                    ...
                    value: function() {
                        ...
                        if (null === this.animOb.offsetPercent) {
                            var o = i.getBoundingClientRect()
                              , s = o.height;
                            o.top >= Z.winSize.height && (r = Lt(s / Z.winSize.height, 0, 1, .3, 0),
                            r = Math.max(Math.min(r, .3), 0))
                        }
                        ...
                        st.i.create({
                            ...
                            onEnter: function() {
                                t.isEnter && (t.isVisible = !0,
                                t.animIn())
                            },
                            onLeave: function() {
                                t.enterOnly && (t.animOb.animUnset && t.animOb.animUnset(),
                                t.removeEvent(),
                                t.isVisible = !1)
                            }
                        })
            ...
            var Wt = function() {
                function t(e) {
                    ...
                    (B(this.DOM.el) || !i.handleScrolling || i.runMobile) && this.DOM.el && (this.onHover = !1,
                    this.options = Ht({}, i),
                    this.init())
                }
                var e, i, n;
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        this.addAnimType(),
                        this.options.handleScrolling && (this.animHelper = new Ct({
                            el: this.DOM.el,
                    ...
                    value: function() {
                        ...
                        if (!this.onHover) {
                            ...
                            var e = Object.assign({
                                onComplete: function() {
                                    Object.assign({}, t.options.to).duration = .3,
                                    ot.p8.fromTo(t.spliters.chars, t.options.from, t.options.to),
                                    t.onHover = !1
                                }
                            }, this.options.out);
                            e.duration = .3,
            ...
            var Kt = function() {
                function t(e, i) {
                    ...
                    this.DOM.el ? B(this.DOM.el) || !i.handleScrolling ? (this.DOM.el.classList.add("anim--lines"),
                    this.options = Ut({}, i),
                    this.animHelper = null,
                    this.addAnimType()) : this.DOM.el.classList.remove("is-anim-loading") : console.log("___not_el_AnimSimpleLine")
                }
                var e, i, n;
                return e = t,
                i = [{
                    ...
                    value: function() {
                        var t, e, i;
                        (e = (t = this).DOM.el).innerHTML = "<span class='d-block line--mask-element'>".concat(e.innerHTML, "</span>"),
                        ...
                        this.options.isHover ? (this.DOM.elemntMaskClose = this.DOM.elemntMask.cloneNode(!0),
                        this.DOM.elemntMaskClose.classList.add("is-clone"),
                        ot.p8.set(this.DOM.elemntMaskClose, this.options.from),
                        this.DOM.el.append(this.DOM.elemntMaskClose)) : ot.p8.set(this.DOM.elemntMask, this.options.from),
                        this.DOM.el.classList.remove("is-anim-loading"),
                        this.options.handleScrolling && (this.animHelper = new Ct({
                            el: this.DOM.el,
                            animIn: this.animIn.bind(this),
                    ...
                    value: function(t) {
                        ...
                        e.delay += t,
                        ot.p8.killTweensOf(this.DOM.elemntMask),
                        ot.p8.fromTo(this.DOM.elemntMask, Ut(Ut({}, {
                            opacity: 1
                        }), this.options.from), e)
                    }
                }, {
                    ...
                    value: function() {
                        var t = this;
                        this.onHover || (this.onHover = !0,
                        ot.p8.killTweensOf([this.DOM.elemntMask, this.DOM.elemntMaskClose]),
                        ot.p8.fromTo(this.DOM.elemntMaskClose, {
                            y: "105%"
                        }, {
                            y: "0%",
                            duration: .6,
            ...
            var ne = function() {
                function t(e) {
                    ...
                    this.DOM.el) {
                        ...
                        (!n || document.body.classList.contains(n)) && (B(this.DOM.el) || !i.handleScrolling || i.runMobile) ? (this.options = $t({}, i),
                        this.addAnimType()) : this.DOM.el.classList.remove("is-anim-loading")
                    } else
                        console.log("___not_el_AnimScale")
                }
                var e, i, n;
                return e = t,
                i = [{
            ...
            var se = function() {
                ...
                (i = [{
                    ...
                    value: function(t) {
                        ...
                        this.motion.current.x = xt(this.motion.current.x, this.motion.last.x, e),
                        this.motion.current.y = xt(this.motion.current.y, this.motion.last.y, e),
                        this.DOM.action.style.transform = "translate(".concat(this.motion.current.x, "px, ").concat(this.motion.current.y, "px)"),
                        this.raf = t
                    }
                }, {
                    key: "onMouseMoving",
                    value: function(t) {
                        var e, i, n, r, o = this.DOM.el.getBoundingClientRect(), s = o.left, a = o.top, l = o.width, u = s + l / 2, c = a + o.height / 2, h = t.clientX - u, f = t.clientY - c, p = function(t, e) {
                            var i = e.x
                              , n = e.y
                        ...
                        n = h,
                        r = f,
                        Math.sqrt(Math.pow(e - n, 2) + Math.pow(i - r, 2))), l / 2), {
                            x: h,
                            y: f
                        }), y = p.x, d = p.y;
                        this.motion.last.x = y,
                        this.motion.last.y = d
                    }
                }, {
                    key: "onMouseEnter",
                    value: function() {}
                    ...
                    key: "onMouseLeave",
                    value: function() {
                        this.motion.last.x = 0,
                        this.motion.last.y = 0
                    }
                }, {
                    key: "bindEvent",
                    value: function() {
                        ...
                        this.DOM.el.addEventListener("mousemove", this.onMouseMoving.bind(this))
                    }
                }, {
                    key: "clear",
                    value: function() {}
            ...
            var ue = function() {
                function t(e) {
                    ...
                    st.i.create({
                        ...
                        onToggle: function(t) {
                            t.isActive ? (i.DOM.li.classList.add("is-active"),
                            r(n)) : i.DOM.li.classList.remove("is-active")
                        }
                    }),
                    this.bindEvent()
                }
            ...
            var fe = function() {
                function t() {
                    ...
                    this.elMenuItems = [],
                    this.DOM.main.querySelectorAll("li a[href]").forEach((function(t) {
            ...
            var de = function() {
                function t(e) {
                    var i = e.el,
                        n = e.onHover,
                        r = e.onLeave,
                        rt = e.onClick; // Add a new property for the onClick callback function
                    ...
                    this.funs = {
                        onHover: n,
                        onLeave: r,
                        onClick: rt, // Store the onClick callback function
                    };
                    this.DOM.el.classList.contains("js-simple-masking_el") ? this.DOM.parent = this.DOM.el.closest(".heading-mask") : this.DOM.el.classList.contains("heading-mask") && (this.DOM.parent = this.DOM.el);
                    this.onEnter = this.onEnter.bind(this);
                    this.onLeave = this.onLeave.bind(this);
                    this.onClick = this.onClick.bind(this); // Add a new method for click interaction
                    this.DOM.el.addEventListener("mouseenter", this.onEnter);
                    this.DOM.el.addEventListener("mouseleave", this.onLeave);
                    this.DOM.el.addEventListener("click", this.onClick); // Add a click event listener
                }
                ...
                return e = t,
                    (i = [{
                        ...
                        value: function() {
                            ...
                            this.DOM.el.removeEventListener("click", this.onClick); // Remove the click event listener when clearing
                        }
                    }]) && ye(e.prototype, i),
                    n && ye(e, n),
                    Object.defineProperty(e, "prototype", {
            ...
            var ke = function() {
                function t(e) {
                    ...
                    this.DOM.heading = this.DOM.main.querySelector(".js-heading-mask_heading"),
            ...
            var je = function() {
                function t(e) {
                    ...
                    this.DOM.videoInner = this.DOM.main.querySelector(".js-videoPlayer_inner"),
                    this.DOM.videoInnerRed = document.querySelector(".js-videoPlayer_inner__red"),
                    this.DOM.videoInRed = document.getElementById("videoPlayer_red"),
                    this.DOM.bigPlay = this.DOM.main.querySelector(".js-btnBigPlay"),
                    this.DOM.cursor = document.querySelector(".js-vj-cursor"),
                    Z.isTouchDevice && this.DOM.main.classList.add("is-touch"),
                    Z.isTouchDevice && this.DOM.videoInnerRed.parentElement.classList.add("is-touch"),
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        De.Z)("videoPlayer", {
                            ...
                            t.player.on("fullscreenchange", t.onFullScreenChange.bind(t)),
                            setTimeout((function() {
                        ...
                        q() && (n = this.player.player().getAttribute("data-poster"),
                        ...
                        st.i.create({
                            ...
                            onToggle: function(e) {
                                ...
                                e.isActive ? (t.playing(),
                                t.isFullSize = !0,
                                Z.isTouchDevice || (t.getSize(),
                                ot.p8.killTweensOf(t.cursor),
                                ot.p8.ticker.add(t.loop))) : (t.pauseVideo(),
                                t.isFullSize = !1,
                                Z.isTouchDevice || (ot.p8.ticker.remove(t.loop),
                                t.onLeave()))
                            },
                            onUpdate: function(e) {
                                if (!Z.isTouchDevice) {
                    ...
                    value: function() {
                        ...
                        this.DOM.videoInnerRed.addEventListener("click", (function() {
                    ...
                    value: function(t) {
                        ...
                        this.cursor.current.x = xt(this.cursor.current.x, this.cursor.last.x, e),
                        this.cursor.current.y = xt(this.cursor.current.y, this.cursor.last.y, e),
                        this.DOM.cursor.style = "--x:".concat(this.cursor.current.x, "px; --y:").concat(this.cursor.current.y, "px; --opacity: ").concat(this.cursor.opacity),
                        this.cursor.raf = t
                    }
                }, {
                    key: "onProgress",
                    ...
                    value: function() {
                        ...
                        Z.isTouchDevice && this.DOM.videoInRed.play()) : (this.player.pause(),
                        Z.isTouchDevice && this.DOM.videoInRed.pause())
                    }
                }, {
                    key: "pauseVideo",
                    value: function() {
                        this.player.paused() || (this.timeSleepControl && clearTimeout(this.timeSleepControl),
                        this.player.pause(),
                        Z.isTouchDevice && this.DOM.videoInRed.pause())
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        try {
                            this.player.isFullscreen() ? (this.player.play(),
                            Z.isTouchDevice && this.DOM.videoInRed.play(),
                            this.player.muted(!1),
                            D.emit(M)) : (this.isFullSize || (this.player.pause(),
                            Z.isTouchDevice && this.DOM.videoInRed.pause()),
                            this.player.muted(!0),
                            D.emit(S))
                        } catch (t) {
                    ...
                    value: function() {
                        ...
                        window.addEventListener("mousemove", this.winMouseMoving.bind(this)),
                        this.DOM.videoInner.addEventListener("mouseleave", this.onLeave.bind(this)),
                        this.DOM.videoInner.addEventListener("mouseenter", this.onEnter.bind(this)),
                        this.DOM.videoInner.addEventListener("mousemove", this.handleMouseMoving.bind(this)),
                        this.DOM.videoInner.addEventListener("click", this.onVideoClick.bind(this)),
            ...
            function Le(t, e) {
                for (var i = 0; i < e.length; i++) {
                    ...
                    "symbol" === Te(o) ? o : String(o)), n)
                }
                var r, o
            }
            function xe(t, e, i) {
                return e && Le(t.prototype, e),
                i && Le(t, i),
                Object.defineProperty(t, "prototype", {
                    writable: !1
                }),
                ...
                (i = [{
                    ...
                    value: function() {
                        ...
                        var t = Z.winSize.height
                          ...
                          , r = (this.DOM.thumbList.getBoundingClientRect(),
                        n.top - i.top + t / 2);
            ...
            var qe = function() {
                function t(e) {
                    ...
                    this.isVisible = !1,
                    !I() || h ? this.scrollTrigger = st.i.create({
                        trigger: n,
                        markers: p,
                        onEnter: r,
                        onEnterBack: s,
            ...
            var Ne = function() {
                ...
                i = [{
                    ...
                    value: function() {
                        var t = this;
                        this.timerId || (this.start = Date.now(),
            ...
            var Ve = function() {
                function t() {
                    ...
                    this.DOM.text = this.DOM.main.querySelector(".js-loading_text"),
                    this.DOM.wrapText = document.getElementById("js-page-loading_text"),
                    this.DOM.progress = document.getElementById("page-loading_circle"),
                    this.DOM.btnStart = document.getElementById("js-page-loading_start"),
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        document.hasFocus() || this.obServerAPI.isVisible ? (this.obServerAPI.removeOb(),
                        this.windowIsBlur = null,
                        document.body.classList.remove("is-loading"),
                        document.body.classList.add("is-loaded"),
                        this.pageLoaded()) : this.windowIsBlur = !0
                    }
                }, {
                    key: "simple",
                    value: function() {
                    ...
                    value: function() {
                        this.isReady && (this.processing.runWidth += this.processing.delta + this.processing.percentStuck,
                        !this.windowLoaded || !this.isReady || this.registerCount > 0 ? (this.processing.delta *= .5 - this.lowNet,
                        this.processing.percentStuck += .05,
                        this.processing.percentStuck *= .8,
                        this.processing.percentStuck >= 2 && (this.processing.percentStuck = 0)) : (this.processing.delta = 5,
                        this.processing.percentStuck = 0)),
                        this.lowNet += 1e-4;
                        var t = parseInt(this.processing.runWidth);
                        t = Math.min(t, this.minProgress),
                        this.showOvalPress(t),
                        this.DOM.wrapInner.style = "--po:".concat(Lt(t, 0, 100, this.strokeDashoffset, 0)),
                        this.DOM.text.textContent = t,
                        t >= 100 && 0 === this.registerCount ? (this.runAnimation || (this.runAnimation = !0,
                        this.pageLoaded()),
                        cancelAnimationFrame(this.idAnimationLoop),
                        this.idAnimationLoop = null) : ("complete" !== document.readyState || this.windowLoaded) && (this.idAnimationLoop = requestAnimationFrame(this.processingLoading),
                        this.processing.runWidth > 100 && (this.minProgress = 100))
                    }
                }, {
                    key: "showOvalPress",
                    value: function(t) {
                    ...
                    value: function() {
                        ...
                        this.clear(),
                        this.isSimpleLoader ? this.startIn() : (this.hide(),
                    ...
                    value: function() {
                        ...
                        this.DOM.main.addEventListener("touchmove", this.disabledTouch)
                    }
                }, {
                    key: "clear",
                    value: function() {
            ...
            var Ye = function() {
                function t(e) {
                    ...
                    this.DOM.txtOff = this.DOM.el.querySelector(".js-footer_sound_list_item__off"),
                    this.DOM.txtOn = this.DOM.el.querySelector(".js-footer_sound_list_item__on"),
                    this.funs = {
                        onClick: n
                    },
                    this.isStatus = "on",
            ...
            var Je = function() {
                function t() {
                    ...
                    this.isAudioPlay = !1,
                    this.elBtns = [],
                    document.querySelectorAll(".js-footer_sound").forEach((function(t) {
            ...
            function oi(t, e) {
                for (var i = 0; i < e.length; i++) {
                    ...
                    "symbol" === ri(o) ? o : String(o)), n)
                }
                var r, o
            }
            function si(t, e, i) {
                return e && oi(t.prototype, e),
                i && oi(t, i),
                Object.defineProperty(t, "prototype", {
                    writable: !1
                }),
            ...
            var fi = function() {
                ...
                i = [{
                    ...
                    value: function(t) {
                        var e = this
                          , i = new ui._;
                        return i.setDecoderPath("./assets/draco/"),
            ...
            var di = function() {
                function t() {
                    ...
                    this.neutralEnvironment = this.pmremGenerator.fromScene(new ni.C).texture,
                ...
                i = [{
                    ...
                    value: function() {
                        ...
                        e.color.setHSL(.6, 1, .6),
                        e.groundColor.setHSL(.095, 1, .75),
                    ...
                    value: function(t) {
                        t.traverse((function(e) {
                            t.isMesh && (e.geometry.dispose(),
                            e.material instanceof Array ? e.material.forEach((function(t) {
                                return t.dispose()
                            }
                            )) : e.material.dispose(),
                            e.removeFromParent())
                    ...
                    value: function() {
                        ...
                        this.camera.fov = 2 * Math.atan(i / 2 / this.perspective) * 180 / Math.PI,
                    ...
                    value: function() {
                        ...
                        Z.isTouchDevice ? window.addEventListener("scroll", this.loop) : rt.lenis.on("scroll", this.loop),
                        D.on(O, this.pageLeave),
            ...
            var Ti = function(t) {
                ...
                var e, i, n, r = Pi(o);
                function o(t) {
                    var e, i = t.el, n = t.url, s = t.position, a = void 0 === s ? new ii.Pa4 : s, l = t.scale, u = void 0 === l ? .02 : l, c = t.rotation, h = void 0 === c ? new ii.Pa4 : c, f = t.scroller, p = void 0 === f ? new ii.Pa4 : f, y = t.onLoaded, d = void 0 === y ? null : y;
                    return function(t, e) {
                        if (!(t instanceof e))
                            throw new TypeError("Cannot call a class as a function")
                    }(this, o),
                ...
                (i = [{
                    ...
                    value: function(t) {
                        ...
                        st.i.create({
                            ...
                            onUpdate: function(t) {
                                var i = t.progress;
                                e.mesh.rotation.z = Lt(i, 0, 1, .5, 1),
                                e.mesh.rotation.x = Lt(i, 0, 1, -.25, 1),
                                e.mesh.rotation.y = Lt(i, 0, 1, -.5, 0)
                            }
                        })
                    }
                }, {
            ...
            var Yi = function(t) {
                ...
                var e, i, n, r = Ui(o);
                function o(t) {
                    var e, i = t.el, n = t.url, s = void 0 === n ? "assets/glb/globe.min.gltf" : n, a = t.onLoaded, l = void 0 === a ? null : a;
                    return function(t, e) {
                        if (!(t instanceof e))
                            throw new TypeError("Cannot call a class as a function")
                    }(this, o),
                ...
                (i = [{
                    key: "onModelLoaded",
                    value: function(t) {
                        z() ? this.mesh.scale.setScalar(1.7) : this.mesh.scale.setScalar(1.9),
                        this.mesh.traverse((function(t) {
                            t.isMesh && (t.material.metalness = 0,
                            t.material.roughness = .75)
                        }
                        ))
                    }
                }, {
            ...
            new (function() {
                ...
                (i = [{
                    ...
                    value: function() {
                        ...
                        new Qi,
                        new Je,
                        (e = document.querySelector(".js-pageContent")) && (e.querySelectorAll(".js-anim--chars:not(.is-handler)").forEach((function(t) {
                            new Wt(t,{
                                handleScrolling: !0,
                                runMobile: !0
                            })
                    ...
                    value: function() {
                        this.initModules(),
                        bt.renderSvgElement(document.querySelector(".js-pageContent"))
                    }
                }, {
                    key: "winPageLoaded",
                    value: function() {
        ...
        if (!i) {
            ...
            for (c = 0; c < t.length; c++) {
                for (var [i,r,o] = t[c], a = !0, l = 0; l < i.length; l++)
                    (!1 & o || s >= o) && Object.keys(n.O).every((t=>n.O[t](i[l]))) ? i.splice(l--, 1) : (a = !1,
                    o < s && (s = o));
                if (a) {
                    t.splice(c--, 1);
                    var u = r();
